...
let cpu: number = 0;
let cpuElement: any = document.body.querySelector("#cpuSelection");
let cpuCounter: number = 0;
let cpuCounterElement: any = document.body.querySelector("#cpuScore");
let playerCounter: number = 0;
let playerCounterElement: any = document.body.querySelector("#playerScore");
let roundsCounter: number = 999;
let roundsCheck: number = 0;
let setRoundsInput: any = document.body.querySelector("#roundsNumber");
let roundsLeftElement: any = document.body.querySelector("#roundsLeft");
let roundsCounterDisplay: number = 999;
